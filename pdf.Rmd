---
title: "Validation des Altimètres"
author: "Préparé par Frédéric Domingue & Justin Beaurivage"
date: "`r Sys.Date()`"
output:
  pdf_document:
...
\rhead{\includegraphics[height=1.6cm]{a-ltips.png}} 
...
knitr::opts_chunk$set(warning = FALSE, echo=FALSE, message=FALSE, results='hide')
...
```{r load data}
#Changer les fichiers ici 

# Protrack_data <- read.csv("profile.csv", sep = ";") fichier bug?
...
# 1. Validation de la mesure d’altitude
...
# retiré family = "A" car bug avec pdf
bland.altman.plot(ys, yss, main=" ", xlab="Moyenne", ylab="Expedite - Flysight",cex.lab = 1.7,cex.axis = 1.7)
title("Bland-Altman Altitude")
```

# 2.	Validation de la vitesse verticale
...
# 3.	Validation de la vitesse horizontale
